...
inline std::mutex mutexUserInputQueue;
inline std::queue<std::string> queueUserInput;

inline std::thread* s_pThreadUserInput = nullptr;
...
inline void LocalUserInput_Kill()
{
